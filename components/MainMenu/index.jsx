...
import './style.scss'
import iconReleases from '../../static/img/svg-icons/food.svg'
import iconArtists from '../../static/img/svg-icons/menu2.svg'
        ...
        return (
            <div className='mainmenu'>
                ...
                <Link to={ prefixLink('/releases/')} className={`mainmenu__link ${ location.pathname.indexOf(prefixLink('/releases/')) == 0 ? 'is-selected' : '' }`} >
                    ...
                    <span className='mainmenu__link-name'>Món ăn</span>
                    <Ink />
                </Link> 
                ...
                <Link to={ prefixLink('/artists/')} className={`mainmenu__link ${ location.pathname.indexOf(prefixLink('/artists/')) == 0 ? 'is-selected' : '' }`} >
                    ...
                    <span className='mainmenu__link-name'>Trà Sữa</span>
                    <Ink />
                </Link> 
